...
laselva.mds
```
_Lo mas importante de ver en este "output" es el **stress**_
...
0.05 - 0.1 is good (can be con???dent in inferences from plot).<br>
...
#### **Step 5: nMDS**
_Otra metrica para evaluar el ajuste (buen desempeno) del nMDS es mirar el "Goodness of ???t"._
```{r}
