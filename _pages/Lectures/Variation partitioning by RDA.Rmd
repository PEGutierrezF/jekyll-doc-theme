...
*Los coeficientes de determinaci&oacute;n (valores R <sup> 2 </sup>) son estimaciones de cu&aacute;nta variaci&oacute;n ha sido "explicada" por una partici&oacute;n determinada. En RDA, estos son simplemente los cuadrados de los coeficientes de correlaci&oacute;n calculados*
...
*Los valores p asociados con los valores R<sup>2</sup> se calcular?n por permutaci&oacute;n. Se probar&iacute;a la importancia del modelo general y las particiones individuales. Solo si el modelo general es significativo deben examinarse las particiones individuales.*
