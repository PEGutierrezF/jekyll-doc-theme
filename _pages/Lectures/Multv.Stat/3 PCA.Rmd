...
PCA is an ordination used to reduce a data set with n cases (e.g., study sites) and p variables (e.g., environmental variables) to a smaller number of synthetic variables that represent most of the information in the set of original data (McCune et al. 2002).<br>
