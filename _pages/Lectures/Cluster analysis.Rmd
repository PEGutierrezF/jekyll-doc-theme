...
## Cluster analysis
Clustering is a technique, non-parametric (Zelterman 2015, page 299), to group similar data points into one group and separate out dissimilar observations into different groups or clusters. In Hierarchical Clustering, clusters are created such that they have a predetermined ordering i.e. a hierarchy.<br>
...
dist.fish <- dist(spe.fish, method = "euclidean") # distance matrix.  You need to calculate this before running the cluster analysis
