...
#### 3.  Before we can use this explanatory matrix we need to check that its rows are in the same order as our response matrix
...
#### 6. vegan requires that we write out each term if we are not going to convert the factor to a dummy matrix
```{r}
